                      ...
                      <div className="flex justify-between items-start gap-4">
                        ...
                        <div className="flex items-center gap-1 shrink-0">
                          <Button
                            ...
                            className="text-zinc-400 hover:text-zinc-900 h-9 w-9 rounded-full hover:bg-zinc-50 transition-colors"
                            title="View Details"
                          >
                          ...
                          <Button
                            ...
                            className="text-zinc-400 hover:text-rose-500 h-9 w-9 rounded-full hover:bg-rose-50 transition-colors"
                          >
              ...
              {selectedDetailTask.taskType === "procurement" && (
                <div className="space-y-4">
                  <div className="flex justify-between items-center text-[10px] uppercase font-black text-zinc-400">
                    ...
                    <span className="text-zinc-800 font-black">{selectedDetailTask.vendorName}</span>
                  </div>
