          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <Card className="p-4 border-none shadow-sm bg-emerald-500/5 rounded-2xl">
                ...
                <p className="text-xl font-black text-emerald-900 italic tracking-tighter">{formatCurrency(order.amount_collected || 0, preferredCurrency)}</p>
              </Card>
              ...
              <Card className="p-4 border-none shadow-sm bg-rose-500/5 rounded-2xl">
                ...
                <p className="text-xl font-black text-rose-900 italic tracking-tighter">{formatCurrency(order.totalAmount - (order.amount_collected || 0), preferredCurrency)}</p>
              </Card>
            </div>
          </div>
